...
function Card({ title, icon, onClick }: CardProps) {
  return (
    <button
      onClick={onClick}
      className="relative w-full h-full min-h-[200px] bg-gradient-to-br from-red-900 to-red-950 rounded-2xl p-6 flex flex-col items-start justify-between hover:scale-[1.02] hover:shadow-2xl transition-all duration-300 group overflow-hidden"
    >
